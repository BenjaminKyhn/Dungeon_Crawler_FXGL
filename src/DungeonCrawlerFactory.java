...
//                .bbox(new HitBox("main", new Point2D(0,0), BoundingShape.box(64, 64)))
    ...
    public Entity newHealthPotion(SpawnData data) {
        ...
        return entityBuilder()
                .type(DungeonCrawlerType.HEALTHPOTION)
                .from(data)
                .viewWithBBox( texture("healthpotion.png"))
                .bbox(new HitBox(BoundingShape.box(12, 14)))
                .with(new CollidableComponent(true))
                .build();
    }
...
//                .bbox(new HitBox(BoundingShape.box(data.<Integer>get("width"), data.<Integer>get("height"))))
    ...
    public Entity newGoblin(SpawnData data) {
        ...
        return entityBuilder()
                .type(DungeonCrawlerType.ENEMY)
                .from(data)
                .bbox(new HitBox("main", new Point2D(6, 14), BoundingShape.box(30, 44)))
                .with(new CollidableComponent(true))
    ...
    public Entity newOgre(SpawnData data) {
        ...
        return entityBuilder()
                .type(DungeonCrawlerType.ENEMY)
                .from(data)
                .bbox(new HitBox("main", new Point2D(6,5), BoundingShape.box(54, 78)))
                .with(new CollidableComponent(true))

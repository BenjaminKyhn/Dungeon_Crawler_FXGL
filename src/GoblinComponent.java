...
public class GoblinComponent extends Component{
    ...
    public void onUpdate(double tpf) {
         ...
         * Target the player
         */
        if (moveTimer.elapsed(Duration.seconds(1.5)) && !rightWallTouched && (player.getX() - entity.getX() > 0) && (player.getX() - entity.getX() < 640) && (player.getX() - entity.getX() > player.getY() - entity.getY()) && !DungeonCrawlerApp.freezeInput) {
            for (int i = 0; i < 32; i++) {
                runOnce(() -> {
        ...
        if (moveTimer.elapsed(Duration.seconds(1.5)) && !leftWallTouched && (player.getX() - entity.getX() < 0) && (player.getX() - entity.getX() > -640) && (player.getX() - entity.getX() < player.getY() - entity.getY()) && !DungeonCrawlerApp.freezeInput) {
            for (int i = 0; i < 32; i++) {
                runOnce(() -> {
        ...
        if (moveTimer.elapsed(Duration.seconds(1.5)) && !topWallTouched && (player.getY() - entity.getY() < 0) && (player.getY() - entity.getY() > -640) && (player.getY() - entity.getY() < player.getX() - entity.getX()) && !DungeonCrawlerApp.freezeInput) {
            for (int i = 0; i < 32; i++) {
                runOnce(() -> {
        ...
        if (moveTimer.elapsed(Duration.seconds(1.5)) && !bottomWallTouched && (player.getY() - entity.getY() > 0) && (player.getY() - entity.getY() < 640) && (player.getY() - entity.getY() > player.getX() - entity.getX()) && !DungeonCrawlerApp.freezeInput) {
            for (int i = 0; i < 32; i++) {
                runOnce(() -> {
